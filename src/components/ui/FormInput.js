...
import {FormInput} from '@rneui/themed';
...
class CustomFormInput extends Component {
  static propTypes = {
    ...
    inputStyle: PropTypes.oneOfType([PropTypes.array, PropTypes.shape({})]),
  };
  ...
  render = () => (
    <FormInput {...this.inputProps()} underlineColorAndroid="transparent" />
  );
}
