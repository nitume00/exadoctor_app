...
class AuthForm extends Component {
  ...
  constructor(props) {
    ...
    const formFields = {};
    if (props.formFields.indexOf('Email') > -1)
      formFields.Email = this.validEmail;
    if (props.formFields.indexOf('Password') > -1)
      formFields.Password = this.validPassword;
    if (props.formFields.indexOf('ConfirmPassword') > -1)
      formFields.ConfirmPassword = this.validPassword;
    if (props.formFields.indexOf('FirstName') > -1)
      formFields.FirstName = FormValidation.String;
    if (props.formFields.indexOf('LastName') > -1)
      ...
      options: {
        fields: {
          ...
          Password: {
            template: TcombTextInput,
            error:
              'Passwords must be more than 8 characters and contain letters and numbers',
            clearButtonMode: 'while-editing',
   ...
   * Email Validation
   */
  validEmail = FormValidation.refinement(FormValidation.String, email => {
   ...
   */
  validPassword = FormValidation.refinement(FormValidation.String, password => {
              ...
              this.setState(
                ...
                () => {
                  ...
                  if (this.props.onSuccessfulSubmit) {
                    return this.props
                      .onSuccessfulSubmit(formData, true)
                      .then(() => {
        ...
        <Card>
          ...
          {(!!this.props.introTitle || !!this.props.introText) && (
            <View>
              ...
              {!!this.props.introText && <Text>{this.props.introText}</Text>}
