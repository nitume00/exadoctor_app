        ...
        return (
          <View style={styles.tabContainer}>
            <ScrollView
              ...
              <Card title={'Buttons'}>
                <View>
                  <Button large title={'Large'} onPress={Actions.comingSoon} />
                  <Spacer size={10} />
                  ...
                  <Button title={'Default'} onPress={Actions.comingSoon} />
                  <Spacer size={10} />
                  ...
                  <Button small title={'Small'} onPress={Actions.comingSoon} />
                  <Spacer size={10} />
            ...
            <ScrollView
              ...
              <Card title={'Typography'}>
                <View>
                  ...
                  <Text h3 onPress={() => Alert.alert('hey')}>
                    Heading 3 with Link
                  </Text>
                  ...
                  <Text p>
                    ...
                    condimentum penatibus neque urna magna.{' '}
                    <Text onPress={() => Alert.alert('hey')}>Leo dictumst</Text>{' '}
          ...
          <View style={styles.tabContainer}>
            <ScrollView
              ...
              <TouchableOpacity
                ...
                <Card
                  image={{
                    uri: 'http://wp-api.mcnam.ee/wp-content/uploads/2016/10/brekkie-crumble-33651_l.jpeg',
                  }}>
                  <View
                    style={[
                    ...
                    <Text>
                      Lorem ipsum diem or seckt original de pingdo of the
                      lespec.
                    </Text>
                  </View>
                </Card>
